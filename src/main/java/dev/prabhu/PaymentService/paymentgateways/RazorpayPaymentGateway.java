...
public class RazorpayPaymentGateway implements PaymentGateway {
    ...
    public String generatePaymentLink(Long orderId, Long amount, String phoneNumber) throws RazorpayException {
        ...
        paymentLinkRequest.put("expire_by", 1707184538);
        paymentLinkRequest.put("reference_id","RP123456");
        paymentLinkRequest.put("description","Payment for policy no #23456");
        JSONObject customer = new JSONObject();
        customer.put("name", "Mr. Singh");
        customer.put("contact",phoneNumber);
        customer.put("email","prabhuraj21.prs.com");
